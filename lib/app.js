...
app.get('/api/search', async(req, res) => {
  try {
    ...
    const queryString = `https://api.spoonacular.com/recipes/complexSearch?instructionsRequired=true&apiKey=${apiKey}&cuisine=${searchTerms.cuisine}&includeIngredients=${searchTerms.ingredients}&diet=${searchTerms.diet}`;
...
app.get('/api/days', async(req, res) => {
  try {
    ...
    const data = await client.query(`
          SELECT days.day AS date, favorites.title, days.owner_id, favorites.source_id, favorites.image_url, favorites.notes
          FROM favorites
          JOIN days ON
