...
app.get('/api/search', async(req, res) => {
  try {
    ...
    const queryString = `https://api.spoonacular.com/recipes/complexSearch?apiKey=${apiKey}&cuisine=${searchTerms.cuisine}&ingredients=${searchTerms.ingredients}&diet=${searchTerms.diet}`;
...
app.get('/api/days', async(req, res) => {
  try {
    ...
    const data = await client.query(`
          SELECT (days.day, favorites.title, days.owner_id, favorites.image_url,      favorites.notes)
          FROM favorites
          JOIN days ON
